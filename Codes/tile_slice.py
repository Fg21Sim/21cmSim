...
# Adopted cosmology
# cosmo = FlatLambdaCDM(H0=71.0, Om0=0.27, Ob0=0.046) # Old weitian cosmology
...
def main():
    ...
    # Cosmology added by Chenxi
    cosmo_ = header['COSMO']
    H0_ = header['H0']
    Om0_ = header['OM0']
    Ob0_ = header['OB0']
    if cosmo_ == "Default":
        cosmo = Planck15.clone(H0=H0_, Om0=Om0_, Ob0=Ob0_)
    else:
        cosmo = FlatLambdaCDM(H0=H0_, Om0=Om0_, Ob0=Ob0_)
